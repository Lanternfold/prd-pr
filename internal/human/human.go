...
const (
	...
	KindStudioPlacement   = "studio_placement"
	KindGitHubAuth        = "github_authentication"
	KindRulesetConflict   = "ruleset_conflict"
	KindDirectoryConflict = "directory_conflict"
	KindProductQuestion   = "product_question"
	KindRuntimeFail       = "runtime_failure"
)
