...
var sectionCatalog = map[string]catalogEntry{
	...
	"scope":                       {Key: "non_goals", Required: false},
	"users":                       {Key: "users", Required: false},
	"user journeys":               {Key: "users", Required: false},
	"use cases":                   {Key: "users", Required: false},
	"runtime":                     {Key: "technical_stack", Required: false},
	"platform":                    {Key: "technical_stack", Required: false},
	"target platform":             {Key: "technical_stack", Required: false},
	"target runtime":              {Key: "technical_stack", Required: false},
	"integrations":                {Key: "integrations", Required: false},
	"external integrations":       {Key: "integrations", Required: false},
	"local run":                   {Key: "testing_engine", Required: false},
	"definition of done":          {Key: "project_completion", Required: false},
